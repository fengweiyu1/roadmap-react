...
import CloudPlatformNode from './components/CloudPlatformNode'
import CloudBrandNode from './components/CloudBrandNode'
import {
  whoami,
...
const nodeTypes = {
  ...
  cloudPlatform: CloudPlatformNode,
  cloudBrand: CloudBrandNode,
}
...
const usNodes = [
  {
    ...
    style: { width: 360 },
    data: {
      label: 'Roadmap of Becoming a Data Engineer',
      description: 'Overall roadmap overview.',
      tutorials: [],
      problems: [],
      noDrawer: true,
    },
  ...
  },
  {
    ...
    style: { width: 208, height: 60 },
    data: {
      lines: ['Phase 2: Core Data', 'Warehousing'],
      tone: 'yellow',
      noDrawer: true,
    },
  },
  {
    ...
    style: { width: 208, height: 60 },
    data: {
      lines: ['Phase 3: Data Pipelines', '& Engineering'],
      tone: 'green',
      noDrawer: true,
    },
  },
  {
    ...
    style: { width: 208, height: 60 },
    data: {
      lines: ['Phase 4: Advanced &', 'Big Data'],
      tone: 'purple',
      noDrawer: true,
    },
  },

  {
    ...
    data: {
      ...
      lines: ['Must-have Pandas / APIs'],
      tone: 'blue',
      description: 'Must-have Pandas / APIs',
      tutorials: [],
      problems: [],
    },
  },
  {
    ...
    data: {
      label: 'Advanced SQL',
      lines: ['Window Functions / Joins'],
      tone: 'blue',
      description: 'Window Functions / Joins',
      tutorials: [],
      problems: [],
    },
  },
  {
    ...
    data: {
      ...
      lines: [],
      tone: 'blue',
      description: 'Linux and Git essentials.',
      tutorials: [],
      problems: [],
    },
  },
  {
    ...
    data: {
      ...
      lines: [],
      tone: 'blue',
      description: 'Container basics with Docker.',
      tutorials: [],
      problems: [],
    },
  },
  ...
  },
  {
    ...
    data: {
      ...
      pill: 'Airflow / Prefect',
      tone: 'green',
      description: 'Airflow / Prefect.',
      tutorials: [],
      problems: [],
    },
  },
  ...
  },
  {
    ...
    data: {
      ...
      pill: 'Databricks',
      tone: 'purple',
      description: 'Apache Spark & PySpark.',
      tutorials: [],
      problems: [],
    },
  },
  ...
  },
  {
    ...
    data: {
      ...
      tone: 'purple',
      variant: 'dashed',
      description: 'Optional: Kafka / Flink.',
      tutorials: [],
      problems: [],
    },
  },

  {
    ...
    style: { width: 720, height: 95, zIndex: 1 },
    data: {
  ...
  },
  {
    id: 'cloud-aws',
    type: 'cloudBrand',
    position: { x: 292, y: 818 },
    style: { width: 128, height: 46, zIndex: 2 },
    data: {
      label: 'aws',
      brand: 'aws',
      showSep: false,
      tutorials: [
        { id: 'aws-checkin', title: '完成打卡', url: 'https://xiaowantree.com' },
      ],
      problems: [],
    },
  },
  {
    ...
    data: {
      ...
      showSep: true,
      tutorials: [
        { id: 'snowflake-checkin', title: '完成打卡', url: 'https://xiaowantree.com' },
      ],
      problems: [],
    },
  },
  {
    ...
    data: {
      ...
      showSep: true,
      tutorials: [
        { id: 'databricks-checkin', title: '完成打卡', url: 'https://xiaowantree.com' },
      ],
      problems: [],
    },
  },
  {
    ...
    data: {
      ...
      showSep: true,
      tutorials: [
        { id: 'dbt-checkin', title: '完成打卡', url: 'https://xiaowantree.com' },
      ],
      problems: [],
    },
  },
...
// ================= Edges（保持你原样）=================
const usEdges = [
  { id: 'us-root-1', source: '0', target: 'phase-1', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-root-2', source: '0', target: 'phase-2', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-root-3', source: '0', target: 'phase-3', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-root-4', source: '0', target: 'phase-4', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p1-0', source: 'phase-1', target: 'p1-python', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p1-1', source: 'p1-python', target: 'p1-advanced-sql', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p1-2', source: 'p1-advanced-sql', target: 'p1-linux-git', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p1-3', source: 'p1-linux-git', target: 'p1-docker', sourceHandle: 'bottom', targetHandle: 'top' },

  { id: 'us-p2-0', source: 'phase-2', target: 'p2-modeling', sourceHandle: 'bottom', targetHandle: 'top' },
  ...
  { id: 'us-p3-2', source: 'p3-orchestration', target: 'p3-automation', sourceHandle: 'bottom', targetHandle: 'top' },

  { id: 'us-p4-0', source: 'phase-4', target: 'p4-distributed', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p4-1', source: 'p4-distributed', target: 'p4-spark', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p4-2', source: 'p4-spark', target: 'p4-realtime', sourceHandle: 'bottom', targetHandle: 'top' },
  { id: 'us-p4-4', source: 'p4-realtime', target: 'p4-optional', sourceHandle: 'bottom', targetHandle: 'top' },

  { id: 'us-h-1', source: 'p1-advanced-sql', target: 'p2-cloud-dw', sourceHandle: 'right', targetHandle: 'left' },
  { id: 'us-h-2', source: 'p2-cloud-dw', target: 'p3-orchestration', sourceHandle: 'right', targetHandle: 'left' },
  { id: 'us-h-3', source: 'p3-orchestration', target: 'p4-spark', sourceHandle: 'right', targetHandle: 'left' },
].map((e) => ({
  ...e,
  type: 'straight',
...
const initialNodes = [
...

  {
    ...
    data: {
      ...
      plan: '1天',
      tutorials: [
        { id: 'cv-1', title: '项目描述写法（待更新）', url: '/blog/de-resume-structure' },
        { id: 'cv-2', title: '简历模版（待更新）', url: '/blog/project-description' },
      ],
      problems: [
...
export default function RoadmapFlow({ mode = 'de' }) {
  ...
  const hasAppliedUsZoomRef = useRef(false)
  ...
  const { baseNodes, baseEdges } = useMemo(() => {
    ...
    const nextNodes = cloneNodes(srcNodes)

    if (mode === 'us') {
      nextNodes.forEach((node) => {
        const isUsCheckinNode = node.type === 'milestone' || node.type === 'cloudBrand'
        if (!isUsCheckinNode) return

        const data = node.data || {}
        const tutorials = Array.isArray(data.tutorials) ? data.tutorials : []
        const problems = Array.isArray(data.problems) ? data.problems : []
        const hasValidItem = [...tutorials, ...problems].some((it) => it?.id)
  ...
  useEffect(() => {
    ...
    setEdges(baseEdges)
    setActiveNode(null)
    hasAppliedUsZoomRef.current = false
  ...
  useEffect(() => {
    ...
    if (hasAppliedUsZoomRef.current) return
    hasAppliedUsZoomRef.current = true
    ...
    rafId = requestAnimationFrame(() => {
      ...
      rafId2 = requestAnimationFrame(() => {
        ...
        reactFlow.setViewport({ x: x + 40, y, zoom }, { duration: 0 })
      })
    })
  ...
  }, [mode, reactFlow, nodesInitialized, fontsReady])
  ...
  useEffect(() => {
    setNodes((prev) =>
      prev.map((node) => {
        if (node.type !== 'roadmap' && node.type !== 'milestone' && node.type !== 'cloudBrand') {
          return node
        }
